...
contract BillPoint is BaseApp {
    ...
    function init_roles(address gateway) external onlyRole(DEFAULT_ADMIN_ROLE) {
        _grantRole(BILLPOINT_ROLE, address(this));
