...
import {RequestPayment, RequestType, RequestStatus} from "./interfaces/Request.sol";
import {User} from "./interfaces/User.sol";
...
contract Gateway is BaseApp {
    ...
    function init_gateway(address _admin) public initializer {
    ...
    function init_roles(
        ...
        _grantRole(GATEWAY_ROLE, address(this));
        _grantRole(BILLPOINT_ROLE, billPoint);
    }
